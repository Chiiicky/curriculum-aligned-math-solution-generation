...
setup(
    ...
    description="RBA-CAV curriculum-constrained reasoning reward built on Open-R1",
    long_description=open("README.md", "r", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    keywords="llm curriculum reward modeling grpo hkg cav",
    license="Apache",
    url="https://github.com/Chiiicky/curriculum-aligned-math-solution-generation",
    package_dir={"": "src"},
    packages=find_packages("src"),
    package_data={"open_r1": ["knowledge_base_graph57.json"]},
    zip_safe=False,
